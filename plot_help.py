...
def grid_plot(table, fig, name_book = None, **kwargs):
    ...
    **kwargs : TYPE
    ...
    if name_book is not None:
        ...
        # Will raise an error if not possible.
        ...
        if len(set(numbers) - name_book.keys()) > 0:
            ds = set(numbers) - name_book.keys()
            raise ValueError(f'None of {ds} are in name_book.')
...
class GridPlot:
    ...
    def __init__(self, table, plot_functions, name_book = None,*,
        ...
        Parameters
        ----------
        table : np.ndarray, 2-dimensional.
            DESCRIPTION.
        ...
        grid_kwargs : TYPE, optional
            Arguments passed to the constructor of GridSpec. The default is empty set.
    ...
    def plot_animation(self, frames, *,
        ...
        if anim_update is None:
            ...
            args_ = (self,) + fargs
            # anim_update(self, frames[123], *fargs)
