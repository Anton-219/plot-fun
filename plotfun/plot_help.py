...
class GridPlot:
    ...
    def __init__(self, table, plot_functions, name_book = None,*,
        ...
        grid_kwargs : dictionary or list with dictionaries as entries, optional.
            ...
            If table is a list (i.e. multiple tables, see nested Gridspecs:
            ...
            then it has to be a list which specifies
    ...
    def plot_animation(self, frames, *,
                       ...
                       animation_time : float = None, end_time : float = None,
        ...
        animation_time : float, optional
            Wished time the animation will take. The video will be so long in seconds.
            Will ignore writer_args['fps'] if given.
            Time unit in seconds. The default is None.
        end_time : float, optional
            The time in seconds the last frame will be shown.
            Happens by appending an approriate number of the last frame to frames to match the time.
            Frames will be converted to a list. So make sure that it is not to big.
            The default is None.
        ...
        if to_save:
            ...
            if animation_time is not None:
                writer_args['fps'] = len(frames)/animation_time
            if end_time is not None:
                frames = list(frames)
                frames.extend([frames[-1]]*math.ceil(writer_args['fps'] * end_time))
